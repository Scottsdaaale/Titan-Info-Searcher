    ...
    <li className="cards__item">
      {
        titanCardState ? (
          // <li className="cards__item">
          <div className="card">
            <img className="card__image" src={titan.img} alt={titan.name} />
          ...
          <div className="card">
            ...
            <div className="card__content">
              ...
              <p className="card__text">Allegiance: {titan.nation}</p>
              <div className="card__detail">
                <label className="ability-text" htmlFor="abilitySelect">
                  Abilities:{" "}
                </label>
                <select
                  ...
                  id="abilitySelect"
                >
                  <option value={titan.abilities.ability1.ability}>
                    {titan.abilities.ability1.ability}
                  </option>
                  <option value={titan.abilities.ability2.ability}>
                    {titan.abilities.ability2.ability}
                  </option>
                </select>
              </div>
              <div className="ability-description">
                {abilityState ? (
                  <p>{titan.abilities.ability1.description}</p>
                ) : (
                  <p>{titan.abilities.ability2.description}</p>
                )}
              </div>
            </div>
          </div>
